    ...
    <div class="row justify-content-center" >
        <div class="col-md-8">
            <div class="card hed_login">
                <div class="card-header">{{ __('Se connecter au compte') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" placeholder="Votre E-mail" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
